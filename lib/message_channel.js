  ...
  if( usePoly || !self.MessageChannel ) {
    ...
    */
    ...
    var _overrideMessageEventListener = function( target ) {
      var targetAddEventListener, addEventListenerName,
          targetRemoveEventListener, removeEventListenerName,
          messageHandler, messageEventType;

      if( target.addEventListener ) {
        targetAddEventListener = target.addEventListener;
        ...
        targetAddEventListener = target.attachEvent;
      ...
      target[addEventListenerName] = function() {
        ...
        targetAddEventListener.apply( this, args );
      };
